...
with gr.Blocks() as demo:
    ...
    gr.Markdown("# GitHubSentinel示例") 
    with gr.Row():
        add_input = gr.Textbox(label="添加新的订阅", placeholder="请输入GitHub项目名称")
    ...
    def on_add_click(new_subscription):
    ...
    add_button.click(fn=on_add_click,inputs=[add_input],outputs=subscription_dropdown,)
